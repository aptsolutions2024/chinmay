...
<head>
  ...
  <title>Salary | Employee ID Card</title>
...
<div class="boxborder" id="margin1">
        ...
        <div class="four  columns"  id="margin1">
         <a href="/idCard"><input type="button" name="Clear" id="Clear" value="Clear" class="btnclass"></a>
