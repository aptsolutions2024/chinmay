...
?>
   <div class="row" style="padding: 0 10px;">
            ...
            <table border="1" width="100%" style="margin-bottom:8px" >
                ...
                <tr>
                    <td height="10px" width="1%">Emp Id :</td><td height="10px" width="30%" colspan="2"><b><?php echo $row["emp_id"]."(".$emprows1["user_name"].")";?> <?php if($emprows1['ticket_no']!=""){ echo "(".$emprows1['ticket_no'].")";}?></b> </td>
		...
		for($l=1;$maxrows>=$l;$l++){
         echo "<tr>";
            if ($l <= $k)
			{
                ...
                $pdf->Cell(20,5,$pdf_arr_days_name[$l],1,0,'L');
...
<?php
$amtinwords = ucwords(convert_digit_to_words($emprows['netsalary']));
   echo "
       <tr>
           <td class='thheading'>";
		   /* if ($reimbursement > 0)
	   ...
	   <tr>
           ...
           <td colspan="7" class="thheading">Net Salary in Words :  Rs. ' . $amtinwords . ' Only/-
    </td>
	   </tr>
	...
	<br/><br/>
			...
			$pdf->Cell(180,5,"Net Salary in Words :  Rs. ".$amtinwords." Only/-",1,1,'L');
			
			$pdf->Cell(180,10,'This is a computer generated report hence does not require any signature.',0,1,'L');
