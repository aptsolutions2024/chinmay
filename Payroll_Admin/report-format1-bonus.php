...
include_once($doc_path .'/paginate.php');
...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>Export Format 1</h3></div>
        <div class="clearFix"></div>
        <form id="form" action="/export-bank-format1" method="post">
