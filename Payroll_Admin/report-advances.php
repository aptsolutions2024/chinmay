...
<div class="twelve mobicenter innerbg">
   ...
   <!-- Client Dropdown -->
        ...
        <div class="three columns">
            <select class="textclass" name="client" id="client" onchange="updateCurrentMonth(); $('#linkshow').hide(); clinentGroupReset()
           " style="width: 100%;">
