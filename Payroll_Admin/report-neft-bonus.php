...
<script>
	...
	function export_neft(type){
		if (type=='e')
		{		
			$("#form").attr('action','/export-leave-bank-neft-format');			
		}
		else
	$("#form").attr('action','/export-leave-bank-nefttext-format');	
	}
...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>NEFT Bonus</h3></div>
        <div class="clearFix"></div>
        <form id="form" action="/export-leave-bank-neft-format" method="post" onsubmit="return validation()">
...
<!--                <input type="button" name="submit" id="submit" value="Save" class="btnclass" onclick="reportpayslip();">-->
                <!--input type="submit" name="submit" id="submit" value="Export" class="btnclass"-->
                				 ...
                				 <input type="submit" name="submit2" value="Export(Text)" class="btnclass" onclick="export_neft('t');">
                <input type="submit" name="submit1" value="Export (excel)" class="btnclass" onclick="export_neft('e');">
